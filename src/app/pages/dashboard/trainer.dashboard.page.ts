...
<div class="card card-body flex-center">
    ...
    <!-- a [routerLink]="['/trainee/createtrainee']" >
      <i class="fa fa-user-plus light-blue-text"></i></a-->
      <i class="fa fa-user-plus light-blue-text"></i>
    </div>
</div>
<!--/.Registration-->
</div>
...
<div class="card card-body flex-center">
    <h5>Assessment</h5>
    <div class="card-circle">
      <i class="fa fa-pencil light-blue-text"></i>
    </div>
</div>
<!--/.Assessment-->
</div>
...
export class trainerdashboardlistpage {
